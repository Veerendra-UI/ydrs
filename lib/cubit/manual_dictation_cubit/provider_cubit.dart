...
class ProviderCubit extends Cubit<ProviderCubitState> {
  ...
  getAllRecordsProvider() async{
    ...
    if(providerApiResponse?.header?.statusCode=="200"){
      ...
      emit(state.copyWith(isLoading: false,errorMsg: providerApiResponse?.header?.statusMessage??ApiResponse.DEFAULT_ERROR_MESSAGE));
    }
  }
}