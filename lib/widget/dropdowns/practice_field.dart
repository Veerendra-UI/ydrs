...
//_currentSelectedValue=data;
  ...
  List<Widget> get appBarActions {
    return ([
      Center(child: Text("Tabs:",style: TextStyle(fontFamily: AppFonts.regular,  fontSize: 14,),)),
      Switch(
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<PracticeListCubit,PracticeCubitState>(listener: (context,state){
        ...
        builder: (context,state)
    {
      return Container(
        ...
        child: SearchableDropdown.single(
          ...
          hint: Text(AppStrings.selectpractice_text,style: TextStyle(fontFamily: AppFonts.regular,  fontSize: 12,),),
          items: data.map((item) {
          ...
          isExpanded: true,
          value: practiceList,
          searchHint: Text('Select ', style: TextStyle(fontSize: 14,fontFamily: AppFonts.regular,fontWeight: FontWeight.bold)),
          onChanged: (value) {
            setState(() {
